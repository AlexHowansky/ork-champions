...
function migrate(){db.characters.toCollection().modify(character=>{const fields={aborted:0,active:0,body:0,campaign:'n/a',dex:0,end:0,flashed:0,id:0,maxBody:0,maxEnd:0,maxRec:0,maxStun:0,name:'n/a',pc:0,reflexes:0,speed:0,status:[],stun:0,};for(const field in character){if(fields[field]===undefined){delete character[field]}}
