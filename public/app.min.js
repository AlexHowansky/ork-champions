...
function getAbortIcon(characerId){if(character.aborted){return'<i class="fa-solid fa-person-arrow-down-to-line text-danger float-end pt-1 pointer" title="Aborted"></i>'}
return''}
