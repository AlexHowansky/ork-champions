$(function(){const config={checkedIcon:'fa-solid fa-check-square text-success',uncheckedIcon:'fa-solid fa-square text-dark',pcIcon:'fa-solid fa-user text-primary',npcIcon:'fa-solid fa-robot text-secondary',activeIcon:'fa-solid fa-check text-success',inactiveIcon:'fa-solid fa-xmark text-danger',accordionClosedIcon:'fa-solid fa-chevron-right',accordionOpenIcon:'fa-solid fa-chevron-down',knockedOutIcon:'<i class="fa-solid fa-face-dizzy text-danger" title="Knocked Out"></i>',recoveryIcon:'<i class="fa-solid fa-square-plus text-danger" title="Take A Recovery" data-recovery="{{characterId}}"></i>',}
